        ...
        >
            ...
            <Menu theme="dark" mode="inline" defaultSelectedKeys={['home']}>
                ...
                <SubMenu key="sub1" icon={<DollarOutlined />} title="收益系统">
                    <Menu.Item key="1"><Link to="/tom" replace>Tom</Link></Menu.Item>
                    <Menu.Item key="2"><Link to="/bill" replace>Bill</Link></Menu.Item>
                    <Menu.Item key="3"><Link to="/alex" replace>Alex</Link></Menu.Item>
                </SubMenu>
                ...
                <Menu.Item key="7" icon={<MessageOutlined />}>
                    <Link to="/user" replace>消息</Link>
                </Menu.Item>
                <Menu.Item key="8" icon={<IdcardOutlined />}>
                    <Link to="/admin" replace>售后服务</Link>
                </Menu.Item>
                <Menu.Item key="9" icon={<StarOutlined />}>
                    <Link to="/admin" replace>收藏夹</Link>
                </Menu.Item>
            </Menu>
        </Sider>
    )
